...
let myOwnArray = ["Yamaha Motorcycle", "Honda Civic car",];
console.log(myOwnArray[0]);
let guestList = ["Akram", "Adil", "Bilal"];
let guestUnableToMakeIt = "Bilal";
let newInvitee = "Zahid";
console.log(`${guestUnableToMakeIt} can't make it to dinner.`);
let indexOfGuestUnableToMakeIt = guestList.indexOf(guestUnableToMakeIt);
...
let placesToVisit = ["Tokyo", "Paris", "SwitzerLand", "Rome", "Berlin"];
...
console.log(placesToVisit.join(", "));
let dinnerguests = ["Shahzaib", "Sajjad", "Talha", "Zahid"];
...
let usernames = ['user1', 'user2', 'user3', 'admin', 'user4', 'user5'];
...
let new_users = ['user6', 'user7', 'User1', 'User2', 'User3'];
...
let Magicians = ["Merlin", "David Copperfield", "Harry Houdini", "Penn & Teller"];
